...
$page_title = 'تقرير المشتريات الشهرية';
...
foreach ($complete_monthly_data as $data) {
    ...
    $yearly_totals['received_count'] += $data['received_count'];
    $yearly_totals['ordered_count'] += $data['ordered_count'];
    $yearly_totals['pending_count'] += $data['pending_count'];
}
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">
                            تقرير المشتريات الشهرية لعام <?php echo $year; ?>
                        </p>
                    </div>
            ...
            <div class="px-6 py-4">
                <form method="GET" class="flex flex-wrap gap-4 items-end">
                    <div>
                        ...
                        <select name="year" class="px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 bg-white">
                    ...
                    <a href="purchases-monthly.php" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
            ...
            <div class="bg-white p-6 rounded-lg shadow border-r-4 border-amber-500">
                <div class="flex items-center">
                    ...
                    <div class="mr-5">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo number_format($yearly_totals['received_count'], 0, '', ''); ?></p>
                    </div>
                </div>
                <div class="mt-2">
                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                        <?php $received_percentage = $yearly_totals['order_count'] > 0 ? ($yearly_totals['received_count'] / $yearly_totals['order_count']) * 100 : 0; ?>
            ...
            <div class="bg-white p-6 rounded-lg shadow border-r-4 border-blue-500">
                <div class="flex items-center">
                    ...
                    <div class="mr-5">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo number_format($yearly_totals['ordered_count'], 0, '', ''); ?></p>
                    </div>
                </div>
                <div class="mt-2">
                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                        <?php $ordered_percentage = $yearly_totals['order_count'] > 0 ? ($yearly_totals['ordered_count'] / $yearly_totals['order_count']) * 100 : 0; ?>
            ...
            <div class="bg-white p-6 rounded-lg shadow border-r-4 border-yellow-500">
                <div class="flex items-center">
                    ...
                    <div class="mr-5">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo number_format($yearly_totals['pending_count'], 0, '', ''); ?></p>
                    </div>
                </div>
                <div class="mt-2">
                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                        <?php $pending_percentage = $yearly_totals['order_count'] > 0 ? ($yearly_totals['pending_count'] / $yearly_totals['order_count']) * 100 : 0; ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">المشتريات الشهرية</h3>
                </div>
                <div class="p-6">
            ...
            <!-- Quarterly Purchases Chart -->
            <div class="bg-white shadow rounded-lg">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">المشتريات الربع سنوية</h3>
                </div>
                <div class="p-6">
                    <canvas id="quarterlyPurchasesChart" height="300"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">تفاصيل المشتريات الشهرية لعام <?php echo $year; ?></h3>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 <?php echo $data['order_count'] == 0 ? 'text-gray-400' : ''; ?>">
                            ...
                            <td class="px-6 py-4 text-sm text-amber-600">
                                <?php echo number_format($data['received_count'], 0, '', ''); ?>
                            </td>
                            <td class="px-6 py-4 text-sm text-blue-600">
                                <?php echo number_format($data['ordered_count'], 0, '', ''); ?>
                            </td>
                            <td class="px-6 py-4 text-sm text-yellow-600">
                                <?php echo number_format($data['pending_count'], 0, '', ''); ?>
                            </td>
                        ...
                        <tr class="bg-gray-50 font-bold">
                            ...
                            <td class="px-6 py-4 text-sm text-amber-600"><?php echo number_format($yearly_totals['received_count'], 0, '', ''); ?></td>
                            <td class="px-6 py-4 text-sm text-blue-600"><?php echo number_format($yearly_totals['ordered_count'], 0, '', ''); ?></td>
                            <td class="px-6 py-4 text-sm text-yellow-600"><?php echo number_format($yearly_totals['pending_count'], 0, '', ''); ?></td>
...
const monthlyPurchasesChart = new Chart(monthlyPurchasesCtx, {
    type: 'bar',
    data: {
        labels: [
...
const quarterlyPurchasesChart = new Chart(quarterlyPurchasesCtx, {
    type: 'pie',
    data: {
        labels: ['الربع الأول', 'الربع الثاني', 'الربع الثالث', 'الربع الرابع'],
        datasets: [{
            label: 'المشتريات الربع سنوية',
            data: [
