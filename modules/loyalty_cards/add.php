...
// Check permission
if (!hasPermission($_SESSION['user_id'], 'loyalty_cards', 'add')) {
    $_SESSION['error_message'] = 'ليس لديك صلاحية للإضافة';
    header('Location: index.php');
    exit();
}

$page_title = 'إضافة بطاقات الهدية';
$success_message = '';
$error_message = '';
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8" dir="rtl">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">إضافة بطاقات الهدية</h1>
