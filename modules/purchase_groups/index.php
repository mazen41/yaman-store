...
// Check permission
if (!hasPermission($_SESSION['user_id'], 'purchase_groups', 'view')) {
...
try {
    ...
    $stmt = $db->prepare("SELECT * FROM purchase_groups $where_sql ORDER BY id DESC");
    $stmt->execute($params);
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-xl shadow-lg p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-blue-100 mt-2">إدارة مجموعات الشراء</p>
            </div>
            <?php if (hasPermission($_SESSION['user_id'], 'purchase_groups', 'add')): ?>
                    ...
                    <?php else: ?>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <?php if (hasPermission($_SESSION['user_id'], 'purchase_groups', 'edit')): ?>
